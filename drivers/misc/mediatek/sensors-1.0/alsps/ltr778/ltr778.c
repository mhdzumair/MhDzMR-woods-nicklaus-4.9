...
//mhdzumair modifying for proper suspand & resume api
static int ltr778_i2c_suspend(struct device *dev);
static int ltr778_i2c_resume(struct device *dev);
...
static const struct dev_pm_ops ltr778_pm_ops = {
	SET_SYSTEM_SLEEP_PM_OPS(ltr778_i2c_suspend, ltr778_i2c_resume)
};
#endif
